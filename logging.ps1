...
$YourModsToLog = "QuestHook[streamer-tools`|v0.1.0]:* QuestHook[QuestSounds`|v0.3.0]:* QuestHook[QuestSounds`|v1.0.0]:* QuestHook[clockmod`|v1.4.0]:* QuestHook[beattogether`|v1.2.4]:* QuestHook[goodbyebug`|v0.1.0]:*"
$OtherModsToLog = "QuestHook[chroma`|v0.1.0]:* QuestHook[moresongs`|v1.0.0]:* QuestHook[config-utils`|v0.2.2]:* QuestHook[mplighting`|v0.1.6]:* QuestHook[multiquestensions`|v0.1.0]:* QuestHook[questom-playlists`|v0.1.0]:* QuestHook[Tweakeroo`|v2.0.0]:* QuestHook[SongDownloader`|v0.0.1]:* QuestHook[goodbyebug`|v0.1.0]:*"
$LibsToLogError = "QuestHook[UtilsLogger`|v1.3.3]:W QuestHook[UtilsLogger`|v1.3.3]:E QuestHook[UtilsLogger`|v1.2.3]:E QuestHook[codegen`|v0.7.0]:E QuestHook[questui`|v0.5.0]:E"
$LibsToLogAll = "QuestHook[UtilsLogger`|v1.3.3]:W QuestHook[UtilsLogger`|v1.3.3]:E QuestHook[UtilsLogger`|v1.3.0]:* QuestHook[UtilsLogger`|v1.2.3]:* QuestHook[codegen`|v0.7.0]:* QuestHook[questui`|v0.5.0]:*"
...
adb logcat -T "$timestamp" main-modloader:W AndroidRuntime:E *:S $YourModsToLog $OtherModsToLog $LibsToLogError
        ...
        if ($args[0] -eq "--file") {
            ...
            $logger = Start-Job -Arg "$timestamp", $PSScriptRoot -scriptblock {
                ...
                adb logcat -v color -T "$timestamp" main-modloader:W libmodloader:W libmain:W AndroidRuntime:E QuestHook[`|v]:* QuestHook[streamer-tools`|v0.1.0]:* QuestHook[QuestSounds`|v0.3.0]:* QuestHook[QuestSounds`|v1.0.0]:* QuestHook[clockmod`|v1.4.0]:* QuestHook[goodbyebug`|v0.1.0]:* *:S | Tee-Object -FilePath "$Path/logcat.log"
            }
